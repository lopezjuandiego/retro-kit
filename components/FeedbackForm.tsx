...
export default function FeedbackForm({ option1, option2 }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto border-t border-gray-100 pt-6 space-y-3 print:hidden">
      ...
      <button
        ...
        className="inline-flex items-center gap-2 bg-gray-800 text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-gray-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
      >
